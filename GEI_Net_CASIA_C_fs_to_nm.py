...
model_name = 'keras_GEINet_casia_fs2nm.h5'
...
with open('/content/drive/My Drive/GEINet_and_PEINet/GEI_Net_CSV/rank_based_GEINet_casia_c_fs2nm.csv', 'w', newline='') as file:
