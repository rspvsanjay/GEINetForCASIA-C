...
model_name = 'GEINet_casia_c_nm2nm.h5'
...
with open('/content/drive/My Drive/GEINet_and_PEINet/GEI_Net_CSV/rank_based_GEINet_casia_c_fb2nm.csv', 'w', newline='') as file:
